  ...
  return (
    <>
      ...
      <Nav scrollNav={scrollNav}>
        ...
        <h3 className="text-left text-gray-200 font-bold lg:text-2xl md:text-3xl">BIG-RIG</h3>
        </NavLogo>
        ...
        <NavBtn>
          ...
          <h3 className="text-left text-gray-200 font-bold text-1xl">@ Copyright Big Rig Trailer and Leasing</h3>
        </NavBtn>
        {/* <MobileIcon onClick={toggle}>
          <FaBars/>
        </MobileIcon> */}
